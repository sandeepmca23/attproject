                        ...
                        <form action="" method="post" role="form" class="php-email-form">
                           <div class="form-group mt-3">
                              <select id="text" name="text" class=" center-margin" placeholder="New Ticket" style="padding:5px; border: 1px solid #c5c5c5;" required>
                                 <option value="Multi Ticket Report ">Multi Ticket Report </option>
                                 <option value="Multi Ticket Report 1">Multi Ticket Report 1</option>
                                 <option value="Multi Ticket Report 1">Multi Ticket Report 2</option>
                                 <option value="Multi Ticket Report 1">Multi Ticket Report 3</option>
                                 <option value="Multi Ticket Report 1">Multi Ticket Report 4</option>
                              </select>
                           </div>
