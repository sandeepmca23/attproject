...
public class InventoryPortCheckAction extends BaseAction implements ModelDriven<Createticket> {
	...
	@Action(value = "inventoryportcheck",
	        results = {
	                @Result(name = "success", location = "inventoryportcheck.jsp"),
	                @Result(name = "error", location = "inventoryportcheck.jsp")
	        })
