...
public class ReportOptionsAction extends BaseAction implements ModelDriven<Createticket> {
	...
	@Action(value = "reportoptions",
	        results = {
	                @Result(name = "success", location = "reportoptions.jsp"),
	                @Result(name = "error", location = "reportoptions.jsp")
	        })
